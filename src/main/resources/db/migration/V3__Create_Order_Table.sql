...
create table `ORDER`(ID bigint not null primary key auto_increment, USER_ID bigint not null,
GOODS_ID bigint not null, GOODS_NUM int not null, GOODS_PRICE decimal not null,
