...
CREATE TABLE `ORDER`(
    ...
    USER_ID BIGINT NOT NULL,--用户ID 不可为空
    GOODS_ID BIGINT NOT NULL,--商品ID 不可为空
    GOODS_NUM INT DEFAULT 0 NOT NULL,--商品数量 不可为空
    GOODS_PRICE INT DEFAULT 0 NOT NULL,--商品单价 不可为空
