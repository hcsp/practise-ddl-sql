...
create table USER (ID bigint primary key auto_increment,
                   NAME varchar(100) not null, TEL varchar(20) not null unique ,
                   ADDRESS varchar(100), CREATED_AT timestamp not null, UPDATED_AT timestamp not null, STATUS boolean not null)